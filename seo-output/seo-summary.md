...
**Generated:** 2026-03-28T06:52:34.345Z  
**Site:** https://toolbox.curioboxapp.info/  
**Total Pages Analyzed:** 371
...
- **Fix Applied:** 0 redirect rules created
...
- **Fix Applied:** 371 noindex rules applied
...
### Redirects
- **Applied:** 0 redirect rules
- **File:** `seo-redirects.json`
- **Integration:** `next.config.js`

### NoIndex Rules
- **Applied:** 371 noindex rules
...
- **Homepage:** https://toolbox.curioboxapp.info//en
- **Tools:** https://toolbox.curioboxapp.info//en/tools/json-formatter
...
- **Sitemap URL:** https://toolbox.curioboxapp.info//sitemap.xml
- **Robots.txt:** https://toolbox.curioboxapp.info//robots.txt
